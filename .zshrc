...
alias ff='firefox'
alias vpn-up='sudo wg-quick up mullvad-ch5'
alias vpn-down='sudo wg-quick down mullvad-ch5'
alias pi-up='sudo wg-quick up pi'
alias pi-down='sudo wg-quick down pi'
